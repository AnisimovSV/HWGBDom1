...
function signUp(item, id) {
  const numbercurrentParticipants = item.parentElement.getElementsByClassName(
    "numbercurrentParticipants"
  );

  const cancelRecordingButton = item.parentElement.getElementsByClassName(
